...
export default function PeriodicReports({ students, activities, onBack, onSelectStudent }: Props) {
  ...
  const report = useMemo(() => {
    ...
    return {
      activeStudents, totalCheckins, supportReqs, avgIntensity, maxIntensity,
      topEmotions, topSkills, helpfulPct, needAttention, positiveCount,
    };
  }, [filteredActivities]);
  ...
  return (
    <div className="min-h-screen bg-background p-4 md:p-6 max-w-5xl mx-auto" dir="rtl">
      ...
      <div className="flex items-center gap-2 mb-6">
        ...
        <h2 className="text-xl font-bold text-foreground">דוחות תקופתיים</h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <div className="card-reset p-5">
          <h3 className="text-base font-bold text-foreground mb-3 flex items-center gap-2">
            <TrendingUp size={16} className="text-primary" /> סיכום {periodLabel}
          </h3>
        ...
        <div className="card-reset p-5">
          <h3 className="text-base font-bold text-foreground mb-3">רגשות נפוצים</h3>
        ...
        <div className="card-reset p-5">
          <h3 className="text-base font-bold text-foreground mb-3">כלים נפוצים</h3>
          <div className="space-y-2">
        ...
        {scope === 'all' && report.needAttention.length > 0 && (
          <div className="card-reset p-5 border border-destructive/20">
            <h3 className="text-base font-bold text-foreground mb-3 flex items-center gap-2">
              ⚠️ תלמידים לתשומת לב
            </h3>
            <div className="space-y-2">
              {report.needAttention.map(s => (
                <div key={s.id} className="flex justify-between items-center text-sm bg-destructive/5 rounded-lg p-2">
